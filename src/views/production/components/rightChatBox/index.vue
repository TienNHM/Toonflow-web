        ...
        <template #footer-prefix>
          <div class="ac" style="gap: 5px">
            ...
            <t-popup trigger="click" placement="top" v-if="showThink">
              <t-button size="small" variant="outline" :theme="thinkLevelTheme">
                <template #icon>
                  <i-tips size="16" />
                </template>
...
const thinkLevelTheme = computed(() => {
  const themes = ["default", "success", "warning", "danger"] as const;
  return themes[thinkLevel.value] ?? "default";
});
